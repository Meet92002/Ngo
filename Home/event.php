...
<body>
<nav class="navbar navbar-expand-lg bg-white sticky-top navbar-light shadow-sm" id="app-navbar">
...
<div class="row">
  <div class="col-12 col-md-6 col-lg-4">
        ...
        <div class="cause-wrap">
        <figure class="m-0">
        <img src="./admin/uploads/eventphoto/IMG_1620493737.jpeg" alt="">
        <div class="figure-overlay d-flex justify-content-center align-items-center position-absolute w-100 h-100">
        <!-- <a href="#" class="btn gradient-bg mr-2">Donate Now</a> -->
        </div>
        </figure>
        <div class="cause-content-wrap">
        <header class="entry-header d-flex flex-wrap align-items-center">
        <h3 class="entry-title w-100 m-0"><img src ="../Assets/Images/rewarding.jpeg" style="height:300px;width:450px; padding:10px"></img>Rewarding education scholarship to super kids</h3>
        </header>
        <div class="entry-content">
        <p class="m-0">HAPPY FOUNDATION rewarding education scholarship to super kids Naina Jaiswal and Agastya Jaiswal who have crossed a milestone in not just achieving name but fame at a very small age.</p>
        </div>
        </div>
        </div>
        </div><div class="col-12 col-md-6 col-lg-4">
...
<br><br>
<!-- Footer -->
<footer class="site-footer" style="background-image: url('../Assets/Images/about1.jpg'); background-repeat: no-repeat; background-size: cover;opacity:">
