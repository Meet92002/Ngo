...
<body style="background-image: url('../Assets/Images/blood2.jpeg'); background-repeat: no-repeat; background-size: cover; ">
  <nav class="navbar navbar-expand-lg sticky-top navbar-light shadow-sm">
    ...
    <ul class="navbar-nav ms-auto ">
      ...
      <button type="button" class=" mx-2 btn btn-outline-success" ><a href="../admin/Blood_donate_tbl.php" style="color:white"> 🡸 BACK TO BLOOD ADMIN</a></button>
    </ul>
    </div>

  </nav>
  <form action="../admin/Blood_donate_tbl.php"method="post" >
