        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Manage Blood Donaters Tables</h1>
                    ...
                    <div class="card-header py-3">
                        <h6 class="m-0 font-weight-bold text-success"> blood Donater User Record  <br><br></h6>
                            <form action="#" method="GET">
                                <div class="input-group mb-3">
                                    ...
                                    &nbsp;&nbsp;&nbsp;<button class='btn btn-outline-success ' type="submit" name="submit"><a href='blood_reg.php?gmail=$result[gmail]'>INSERT</a></button>
                                </div>
                                </form>
                        </div>
                        <div class="card-body">
                        ...
                        <!-- <form method="post"> -->
                             ...
                             <?php
                                    ...
                                    $searchQuery="SELECT * FROM blood_donate WHERE CONCAT(fname,lname,bldg,gmail) LIKE'%$filtervalues%'";
                                    $searchData=mysqli_query($conn,$searchQuery);
                                    $searchRow=(mysqli_num_rows($searchData)>0);

                                    $query = "select * from blood_donate";
                                    ...
                                    if($filtervalues == "")
                                    {
                                        ...
                                        if($total != 0)
                                        {
                                            echo "<thead>";
                                                ...
                                                echo "<th>Before Blood Donated</th>";
                                                echo "<th>Any Disease</th>";
                                                echo "<th>Any Allergies</th>";
                                                echo "</tr>";
                                            echo "</thead>";
                                        ...
                                        if($searchRow != 0)
                                        {
                                            ...
                                            while($searchRow = mysqli_fetch_assoc($searchData))
                                            {
                                                echo "<tbody>";
                                                    ...
                                                    echo "<td>"; echo $searchRow['bldg']; echo"</td>";                                                   
                                                    echo "<td>"; echo $searchRow['option1']; echo"</td>";
                                                    echo "<td>"; echo $searchRow['option2']; echo"</td>";
                                                    echo "<td>"; echo $searchRow['option3']; echo"</td>";
