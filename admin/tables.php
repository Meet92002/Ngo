...
<body id="page-top">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Manage User Tables</h1>
                    ...
                    <div class="card-header py-3">
                        <h6 class="m-0 font-weight-bold text-success">  User Record  <br><br></h6>
    ...
    <script>
        ...
        function checkdelete()
        {
            ...
            <meta http-equiv="refresh" constant="0 url=http://localhost/Ngo/admin/tables.php?search=#">
        }
    </script>
