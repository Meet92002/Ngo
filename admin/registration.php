...
<body style="background-image: url('../Assets/Images/bg8.jpeg'); background-repeat: no-repeat; background-size: cover; ">
  <nav >
    ...
    <a class="navbar-brand" href="../Home/home.php" style="padding-right: 100px;"><img src="../Assets/Logo/logo4.png"
    style="width:50px; height: 45px" ></img> <strong>HAPPY FOUNDATION</strong></a>
      <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarNavDropdown"
      aria-controls="navbarNavDropdown" aria-expanded="false" aria-label="Toggle navigation">
      <span class="navbar-toggler-icon"></span>
    </button>
    <button type="button" class=" mx-2 btn btn-outline-success " style="padding-right:89" ><a href="../admin/tables.php" style="color:white; "> 🡸 BACK TO BLOOD ADMIN</a></button>
...
?>
  ...
  <form  action="../Home/sign-up.php" method="post" class="needs-validation">
  ...
  oninput="this.setCustomValidity('')" required>
              ...
              <button type="submit" class="btn btn-outline-success mt-4" name="submit"  href="../admin/tables.php"  >SIGN-UP</button>

              <div >
              <p class="mb-2">Have you an account? <a class="text-white-50 fw-bold">  SIGN-IN <i class="bi bi-arrow-right-square-fill"></i></a>
              </p>
            </div>
            </div>
          </div>
  ...
  else if($password != $cpassword)
  {
    ...
    { #if data inserted succesfully
            ...
            ?>
             ...
             <meta http-equiv = "refresh" content="0 url=http://localhost/Ngo/Home/sign-up.php">
            <?php
